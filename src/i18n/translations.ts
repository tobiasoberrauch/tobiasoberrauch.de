  ...
  de: {
    ...
    pages: {
      ...
      giftedness: {
        ...
        lead: 'Informationen, Recherchen und persönliche Erfahrungen zum Thema Hochbegabung bei Kindern und Erwachsenen. Als Elterngruppenleiter beim LVH Baden-Württemberg sammle ich hier Wissen für Familien.',
        statsTitle: 'Hochbegabung in Zahlen',
        stats: [
          { label: 'der Bevölkerung', value: '2 %' },
          { label: 'IQ-Schwelle', value: '130+' },
          { label: 'Familien im LVH', value: '320' },
          { label: 'Elterngruppen BaWü', value: '20' },
        ],
        topicsHeading: 'Themenbereiche',
        topics: [
          { title: 'Erkennung & Testung', body: 'Wie erkennt man Hochbegabung? Welche Tests gibt es? Ab welchem Alter ist eine Testung sinnvoll?' },
          { title: 'Schule & Förderung', body: 'Schulwahl, Überspringen, Enrichment, Akzeleration — Wege für hochbegabte Kinder im Bildungssystem.' },
          { title: 'Sozial-Emotionales', body: 'Asynchrone Entwicklung, Perfektionismus, Unterforderung und der Umgang damit.' },
  ...
  en: {
    ...
    pages: {
      ...
      giftedness: {
        ...
        lead: 'Information, research and personal experience on the topic of giftedness in children and adults. As a parents-group leader at LVH Baden-Württemberg, I gather knowledge here for families.',
        statsTitle: 'Giftedness by the numbers',
        stats: [
          { label: 'of the population', value: '2 %' },
          { label: 'IQ threshold', value: '130+' },
          { label: 'families at LVH', value: '320' },
          { label: 'parent groups in BW', value: '20' },
        ],
        topicsHeading: 'Areas',
        topics: [
          { title: 'Detection & testing', body: 'How is giftedness identified? Which tests exist? From what age does testing make sense?' },
          { title: 'School & support', body: 'Choosing a school, grade-skipping, enrichment, acceleration — pathways for gifted children in the education system.' },
          { title: 'Socio-emotional', body: 'Asynchronous development, perfectionism, under-stimulation, and how to navigate them.' },
  ...
  la: {
    ...
    pages: {
      ...
      giftedness: {
        ...
        lead: 'Notitiae, investigationes et experientiae privatae de ingenio infantum et adultorum. Ut dux circuli parentum apud LVH Baden-Württemberg hic cognitionem familiis colligo.',
        statsTitle: 'Ingenium in numeris',
        stats: [
          { label: 'populi', value: '2 %' },
          { label: 'limes IQ', value: '130+' },
          { label: 'familiae apud LVH', value: '320' },
          { label: 'circuli parentum BW', value: '20' },
        ],
        topicsHeading: 'Argumenta',
        topics: [
          { title: 'Inventio et probatio', body: 'Quomodo ingenium agnoscitur? Quae probationes existunt? A qua aetate probatio prudens est?' },
          { title: 'Schola et fovendum', body: 'Electio scholae, gradus transcendere, locupletatio, acceleratio — viae infantium ingeniosorum in re scholastica.' },
          { title: 'Socialia et affectus', body: 'Evolutio asynchrona, cupido perfectionis, defectus stimuli, et quomodo tractentur.' },
  ...
  grc: {
    ...
    pages: {
      ...
      giftedness: {
        ...
        lead: 'Εἰδήσεις, ἔρευναι καὶ προσωπικαὶ ἐμπειρίαι περὶ τῆς εὐφυΐας τῶν παίδων καὶ τῶν τελείων. Ὡς ἡγούμενος κύκλου γονέων παρὰ τῷ LVH Baden-Württemberg ἐνταῦθα γνῶσιν ταῖς οἰκογενείαις συνάγω.',
        statsTitle: 'Ἡ εὐφυΐα ἐν ἀριθμοῖς',
        stats: [
          { label: 'τοῦ λαοῦ', value: '2 %' },
          { label: 'οὐδὸς IQ', value: '130+' },
          { label: 'οἰκογένειαι ἐν τῷ LVH', value: '320' },
          { label: 'κύκλοι γονέων BW', value: '20' },
        ],
        topicsHeading: 'Θέματα',
        topics: [
          { title: 'Ἀναγνώρισις καὶ δοκιμασία', body: 'Πῶς γιγνώσκεται ἡ εὐφυΐα; Ποῖαι δοκιμασίαι ὑπάρχουσιν; Ἀπὸ ποίας ἡλικίας ἡ δοκιμασία φρόνιμος;' },
          { title: 'Σχολεῖον καὶ ὑποστήριξις', body: 'Ἐκλογὴ σχολείου, ὑπερβολὴ τάξεων, πλουτισμός, ἐπιτάχυνσις — ὁδοὶ παίδων εὐφυῶν ἐν τῷ παιδευτικῷ συστήματι.' },
          { title: 'Κοινωνικὰ καὶ συναισθηματικά', body: 'Ἀσύγχρονος ἀνάπτυξις, τελειοκρατία, ἔλλειψις ἐρεθίσματος, καὶ ἡ μετ’ αὐτῶν συναναστροφή.' },
